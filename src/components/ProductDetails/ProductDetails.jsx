                    ...
                    <div className={Style.child2}>
                        <div className={Style.producticons}>
                                ...
                                {fav.length !== 0 ?
                                    ...
                                    (<button className={Style.productbtns} onClick={() => addFavs(productId)}><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-suit-heart" viewBox="0 0 16 16">
                                ...
                                {cart.length !== 0 ?
                                    ...
                                    (<button className={Style.productbtns} onClick={() => addShoppingCart(productId)}><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">

    ...
    return(
        ...
        <><Head/>
            ...
            <div className= {Style.cont}>
                <div className={Style.titulo}>{detailsProduct.name}</div>
                ...
                <div className={Style.grid}>
                    ...
                    <div className={Style.detalles}>
                        <div><b>Precio: </b>${Number(Math.ceil(detailsProduct.price)).toLocaleString()} </div> <br />
                        <div><b>Marca: </b>{detailsProduct.brand}</div><br />
                        <div >
                            <b>Descripción: </b>
                            <div className={Style.text}>{detailsProduct.description} </div>
                        </div><br />
                        <div><b>Stock: </b>{detailsProduct.stock} unidades </div><br />

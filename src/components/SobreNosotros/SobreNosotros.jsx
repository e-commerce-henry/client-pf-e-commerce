...
const SobreNosotros = () => {
  ...
  <div>
    <Head />
    <div><h3 className="title1">SOMOS MARCA DEL E-COMMERCE</h3></div>
    ...
    Somos lo que querés, cuando querés, donde querés. Somos <b>MARCA DEL E-COMMERCE.</b></p></div>
    ...
    {/* <div className="equipo"><Link to="/equipo">Nuestro Equipo</Link></div> */}

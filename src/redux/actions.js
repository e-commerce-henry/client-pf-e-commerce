...
export const addUsers = (payload) => {
    return async (dispatch) => {
        let response = await axios.post(`http://proyecto-personal.online/auth/signup`, payload);
        return response;
    }
}
//Responder
export const addInicioUser = ({email, pwd}) => {
    return  (dispatch) => {
        axios.post(`http://proyecto-personal.online/auth/signIn`, {email, pwd}, { withCredentials: true })
        .then(res =>{
            res.data.user? 
...
export function removeCart(id){
    return async function (dispatch){
        let json = await axios.post(`http://proyecto-personal.online/cart`, id)
        dispatch({
            type: REMOVE_CART,
            payload: json.data
        })
...
export function createReview(id,review){
    return dispatch => {
        axios.post(`http://proyecto-personal.online/productReview/${id}/review`,review)
        .then((result) => {
            return dispatch({
                type:CREATE_REVIEWS,
                payload: result.data
...
export function getReview(id){
    return dispatch => {
        axios.get(`http://proyecto-personal.online/productReview/${id}/review`)
        .then((result) => {
            return dispatch({
                type:GET_REVIEWS,
                payload:result.data
...
export function getSaleBanner() {
	return  (dispatch) => {
		axios.get("http://proyecto-personal.online/saleBanner")
        .then((result) => {
            return dispatch({
                type: GET_SALEBANNER,
                payload: result.data
...
export function createOrder(userId, body){
    return async function(dispatch){
        await axios.post(`http://proyecto-personal.online/orders/${userId}`, body)
        dispatch({
            type: CREATE_ORDER
        })
    }
